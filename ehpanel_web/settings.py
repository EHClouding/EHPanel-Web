...
LOCAL_POSTFIX_TLS_SNI_MAP_FILE = os.environ.get("LOCAL_POSTFIX_TLS_SNI_MAP_FILE", "/etc/postfix/ehpanel-tls-sni")
LOCAL_POSTFIX_TLS_SNI_CHAIN_DIR = os.environ.get("LOCAL_POSTFIX_TLS_SNI_CHAIN_DIR", "/etc/postfix/ehpanel-sni-chains")
LOCAL_DOVECOT_TLS_SNI_CONF_FILE = os.environ.get("LOCAL_DOVECOT_TLS_SNI_CONF_FILE", "/etc/dovecot/conf.d/99-ehpanel-sni.conf")
...
MAIL_CLIENT_HOSTNAME = os.environ.get("MAIL_CLIENT_HOSTNAME", LOCAL_PANEL_HOSTNAME).strip()
